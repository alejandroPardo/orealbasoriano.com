...
const About = () => {
  ...
  const skills = ['Búsqueda de información para diferentes tipos de contenidos', 'Organización y trabajo con el equipo interno y externo de la oficina', 'Creación de contenido para redes sociales y blogs', 'Creación de contenido para editoriales de lifestyle', 'Contacto directo con los clientes de diversas marcas', 'Organización para maquetación de la revista'];
